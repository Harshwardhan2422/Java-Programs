...
class BST 
{
    ...
    public int SumOfLeftChild(node temp)
    {
        int iCount = 0;
        ...
        if(temp != null)
        {
            ...
            iCount = iCount + SumOfLeftChild(temp.lchild);
            iCount = iCount + SumOfLeftChild(temp.rchild);            
        }
        return iCount;
    }
    
    public int SumOfRightChild(node temp)
    {
        int iCount = 0;
        ...
        if(temp != null)
        {
            ...
            iCount = iCount + SumOfRightChild(temp.lchild);
            iCount = iCount + SumOfRightChild(temp.rchild);
        }
        return iCount;
    }
...
class Program370
{
    public static void main(String A[])
    {
        ...
        iRet = obj.SumOfLeftChild(obj.head);
        System.out.println("Sum Of Left Child is : "+iRet);
        
        iRet = obj.SumOfRightChild(obj.head);
        System.out.println("Sum Of Right Child is : "+iRet);
        
        iRet = obj.Height(obj.head);
        System.out.println("Height of BST is : "+iRet);
